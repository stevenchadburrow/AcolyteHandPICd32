...
void Setup()
{
	...
	PB2DIV = 0x00008009; //0x00008003; // change PB2 clock to 200 / 10 = 20 MHz for SPI and UART
	...
	SPLLCON = 0x01310201; //0x02270203; // use PLL to bring external 24 MHz into 200 MHz
	...
	OC2R = 0x02E0; // h-visible rise
	OC2RS = 0x0F60; // h-blank fall
	...
	// set up UART here
	U3BRG = 0x0081; // 20 MHz to 9600 baud = 20000000/(16*9600)-1 = 129.208 = 0x0081

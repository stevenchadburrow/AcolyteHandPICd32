...
void __attribute__((optimize("00"),vector(_OUTPUT_COMPARE_3_VECTOR), interrupt(ipl7srs))) oc3_handler()
{		
...
void __attribute__((optimize("00"),vector(_CHANGE_NOTICE_D_VECTOR),interrupt(ipl4srs))) cnd_handler()
{
